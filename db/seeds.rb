...
if Rails.env.development?
  	store = Store.create(name:'Store 1', active_at: Time.current, master: '39426385 5100601')
  	...
  	store.accounts.create(name:3000032061, state: :enable, kind: :telegram, trace_ids: [1,2,4])
	store.accounts.create(name:3000032064, state: :enable, kind: :telegram, trace_ids: [6])
	store.accounts.create(name:3000032065, state: :enable, kind: :telegram, trace_ids: [7])
	store.accounts.create(name:3000032097, state: :enable, kind: :telegram, trace_ids: [5])
	store.accounts.create(name:3000032061, state: :enable, kind: :copy, trace_ids: [3])


elsif Rails.env.production?
  	store = Store.create(name:'Store 1', active_at: Time.current, master: '3007712')
