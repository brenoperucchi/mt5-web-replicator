...
store.traces.create(name: 'M15 Signals Premium', name_id:'-1001222448337', active_at: DateTime.now, telegram_option:'query_name_id', telegram_image:true)
store.traces.create(name: 'Swing Trading ViP', name_id:'-1001159029077', active_at: DateTime.now, telegram_option:'query_name', telegram_image:false)
