...
class SignsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sign" do
    assert_difference('Sign.count') do
      post signs_url, params: { sign: { currency: @sign.currency, kind: @sign.kind, price: @sign.price, sp: @sign.sp, tp: @sign.tp } }
    end
  ...
  test "should update sign" do
    patch sign_url(@sign), params: { sign: { currency: @sign.currency, kind: @sign.kind, price: @sign.price, sp: @sign.sp, tp: @sign.tp } }
