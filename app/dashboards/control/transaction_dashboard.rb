...
class Control::TransactionDashboard < Administrate::BaseDashboard
  ...
  ATTRIBUTE_TYPES = {
    ...
    order:              Fields::BelongsToField.with_options(associated: :current_store, dashboard:'control'),
    trace:              Fields::BelongsToField.with_options(associated: :current_store, dashboard:'control'),
    message:            Fields::BelongsToField.with_options(associated: :current_store, dashboard:'control'),
    account:            Fields::BelongsToField.with_options(associated: :current_store, dashboard:'control'),
