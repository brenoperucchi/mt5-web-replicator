...
RSpec.describe API::V1::APITransactionsCopy do
  before(:context) do
    ...
    params: {"orders"=>"{\"ticket_id\":334171133,\"price\":14946.46000000,\"volume\":0.20000000,\"stop_loss\":14782.05000000,\"take_profit\":14976.35000000,\"type\":0,\"magicnumber\":703,\"symbol\":\"UsaTec\",\"comment\":\"VLL[7AF] E$|B 0.20\",\"open_at\":\"1644417000\",\"state_meta\":null}//
                        ...
                        {\"ticket_id\":10001,\"price\":14940.05000000,\"volume\":0.20000000,\"stop_loss\":15036.41000000,\"take_profit\":14843.06000000,\"type\":1,\"magicnumber\":704,\"symbol\":\"UsaTec\",\"comment\":\"VLL[9CE] N$|S 0.80\",\"open_at\":\"1644424361\",\"state_meta\":null}//
  ...
  describe API::V1::APITransactionsCopy do
    context 'POST' do
      it 'Hedging - Verify Slave has orders and before delete 1 order the count was correctly' do 
        ...
        expect(response.body).to be ==  "1|10001|0|1|2|20001|1|14940.05|0.2|15036.41|14843.06|pending|UsaTec|0|0|10001|0/1|334198080|0|1|4|20001|2|2075.9|1.0|2091.0|2053.0|pending|UsaRus|0|0|334198080|0/1|334199528|0|1|6|20001|3|113180.0|1.0|114230.0|112760.0|pending|Bra50|0|0|334199528|0"
    ...
    context 'POST' do
      it 'Hedging - Verify Slave has orders and before delete 1 order the count was correctly' do
        ...
        post '/api/v1/transactions/copy/trasmit/signal_copy/1_64/orders/5647753/NETTING',
          params: {"orders"=>"{\"ticket_id\":10001,\"price\":14940.05000000,\"volume\":0.30000000,\"stop_loss\":15036.41000000,\"take_profit\":14843.06000000,\"type\":1,\"magicnumber\":704,\"symbol\":\"UsaTec\",\"comment\":\"VLL[9CE] N$|S 0.80\",\"open_at\":\"1644424361\",\"state_meta\":modify}"}
...
#         @slave.execute
#         post '/api/v1/transactions/copy/trasmit/signal_copy/1_3_0/5647753/NETTING', 
#           params: {"orders"=>"{\"ticket_id\":10000002,\"price\":1.13473000,\"volume\":0.02000000,\"stop_loss\":1.1000000,\"take_profit\":1.2000000,\"type\":0,\"magicnumber\":0,\"symbol\":\"EURUSD\",\"comment\":null,\"open_at\":\"1642789795\",\"state_meta\":\"\"}", 
...
#         @slave.execute
#         post '/api/v1/transactions/copy/trasmit/signal_copy/1_3_0/5647753/NETTING', 
#           params: {"orders"=>"{\"ticket_id\":10000001,\"price\":1.13473000,\"volume\":0.02000000,\"stop_loss\":1.1000000,\"take_profit\":1.2000000,\"type\":0,\"magicnumber\":0,\"symbol\":\"EURUSD\",\"comment\":null,\"open_at\":\"1642789795\",\"state_meta\":\"modify\"}//{\"ticket_id\":10000002,\"price\":1.13473000,\"volume\":0.02000000,\"stop_loss\":1.1000000,\"take_profit\":1.2000000,\"type\":0,\"magicnumber\":0,\"symbol\":\"EURUSD\",\"comment\":null,\"open_at\":\"1642789795\",\"state_meta\":\"\"}",
#           "expert_name"=>"signal_copy", "expert_version"=>"1_30", "account_id"=>"5647753", "account_mode"=>"NETTING"}
#         @slave = account.transactions.find_by(ticket:@ticket_master).slaves.find_by(ticket_master: @ticket_master)
