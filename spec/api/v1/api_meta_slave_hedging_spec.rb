...
RSpec.describe API::V1::APITransactionsCopy do
  before(:context) do
    ...
    post '/api/v1/transactions/copy/trasmit/signal_copy/1_40/orders/5647753/HEDGING',
  ...
  describe API::V1::APITransactionsCopy do
    context 'POST' do
      it 'Hedging - Verify Slave has orders and before delete 1 order the count was correctly' do
        ...
        expect(response.body).to be == "1|334199527||1|18|704|18|||15036.41|14843.06|pending|UsaTec|0|0|334199527/1|334197995||1|19|704|19|||15036.41|14843.06|pending|UsaTec|0|0|334197995/1|334197268||1|20|704|20|||15036.41|14843.06|pending|UsaTec|0|0|334197268/1|334196413||1|21|704|21|||15036.41|14843.06|pending|UsaTec|0|0|334196413/0|334185075||1|22|703|22|0||14782.05|14976.35|pending|UsaTec|0|0|334185075/0|334171133||1|23|703|23|0||14782.05|14976.35|pending|UsaTec|0|0|334171133/1|334198080||1|24|5502|24|||2091.0|2053.0|pending|UsaRus|0|0|334198080/1|334198079||1|25|702|25|||2086.3|2059.47|pending|UsaRus|0|0|334198079/1|334197255||1|26|702|26|||2086.3|2059.47|pending|UsaRus|0|0|334197255/1|334190820||1|27|702|27|||2086.3|2059.47|pending|UsaRus|0|0|334190820/0|334186108||1|28|701|28|0||2050.17|2077.12|pending|UsaRus|0|0|334186108/1|334181440||1|29|5502|29|||2091.0|2053.0|pending|UsaRus|0|0|334181440/1|334179884||1|30|702|30|||2086.3|2059.47|pending|UsaRus|0|0|334179884/1|334171235||1|31|702|31|||2086.3|2059.47|pending|UsaRus|0|0|334171235/1|334199528||1|32|706|32|||114230.0|112760.0|pending|Bra50|0|0|334199528/1|334198352||1|33|706|33|||114230.0|112760.0|pending|Bra50|0|0|334198352/0|334198351||1|34|705|34|0||111760.0|113230.0|pending|Bra50|0|0|334198351"
    ...
    context 'POST' do
      it 'Hedging - Verify Slave has orders and before delete 1 order the count was correctly' do
        post '/api/v1/transactions/copy/trasmit/signal_copy/1_40/orders/5647753/HEDGING',
          params: {"orders"=>"[]"}
        expect(@account1.slaves.last.state).to be == "closed"
        post '/api/v1/transactions/trasmit/signal_slave/1_53/5634787/HEDGING', 
          params: {"body"=> "{'account_login':'5634787', 'magic_number':'704', 'action':'NOSLTP', 'ticket_slave_id':'0', 'deal_ticket':'0', 'order_symbol':'UsaTec', 'order_type':'1', 'open_price':'14940.800000', 'close_price':'0.000000', 'volume':'0.200000', 'stop_loss':'15036.41000000', 'take_profit':'14843.06000000', 'profit':'0.000000', 'comment':'334199527', 'open_at':'1644424225.000000', 'meta_message':'OrderSend Done | Retcode: 10009 | Deal: 290610221 | Order: 334199552 | Comment: 334199527'}", "expert_name"=>"signal_slave", "expert_version"=>"1_53", "account_id"=>"3000033104", "account_mode"=>"HEDGING"}
        # binding.pry
