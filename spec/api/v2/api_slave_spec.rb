...
RSpec.describe 'OrdersHistory API', type: :request do
  ...
  describe 'POST /api/v2/slave/orders_history/post/imentore_slave/2_21/MetaQuotes/20100/HEDGING' do
    ...
    it 'Conciliate Orders - Verify profit and do action close slave' do
      ...
      expect(TransactionSlave.find_by(comment: "10000001").state).to be == "remove"
      expect(TransactionSlave.find_by(comment: "10000002").state).to be == "remove"
    ...
    it 'Conciliate Orders - Create New Slave in older Order' do
      ...
      expect(Order.find_by(content_id: 10000015).slaves.count).to be == 1
    ...
    it 'Conciliate Orders - Create New Slave in New Order' do
      ...
      expect(Order.find_by(content_id: 99000013).present?).to be true
