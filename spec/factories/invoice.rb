FactoryBot.define do
  ...
  factory :invoice do
    ...
    state {"pending"}
    amount { 0.124004e4 }
    settings { {"payment_link"=>"https://www.mercadopago.com.br/checkout/v1/redirect?pref_id=77964627-2bdcc329-f71c-40dc-ae03-ce7bce611411"} }
    store_id { 1 }
    payment_id { 9 }
    plan_usage_id { 571 }
    response {"{:status=>201,
        :response=>
            {'additional_info'=>',
             ...
             'binary_mode'=>false,
             'client_id'=>'8003379344962428',
             'collector_id'=>77964627,
             'coupon_code'=>nil,
             'coupon_labels'=>nil,
             ...
             'id'=>'77964627-2bdcc329-f71c-40dc-ae03-ce7bce611411',
             'init_point'=>'https://www.mercadopago.com.br/checkout/v1/redirect?pref_id=77964627-2bdcc329-f71c-40dc-ae03-ce7bce611411',
             ...
             'sandbox_init_point'=>'https://sandbox.mercadopago.com.br/checkout/v1/redirect?pref_id=77964627-2bdcc329-f71c-40dc-ae03-ce7bce611411',
             'site_id'=>'MLB',
